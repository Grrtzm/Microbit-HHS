/*
   ...
   20190601 Uitbreiding Gert: Via seriële monitor (USB) en Bluetooth verzonden karakters worden op matrix display weergegeven.
...
void loop() {
  ...
  /* Gert 20190601: Zo kun je het matrix display samen met Bluetooth gebruiken:
    ...
    // Zie Adafruit voorbeeld "matrixdemo". Normaal zou hier staan:
